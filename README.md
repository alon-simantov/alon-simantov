...
- Hands-on experience with the exact patterns ServiceNow uses in AI Agent Studio, Now Assist, and Moveworks  
- Forward-deployed mindset: turning complex technical requirements into working AI implementations and POCs

Open to **Senior AI Implementation Engineer**, **AI Solution Architect**, and **Forward Deployed** roles at ServiceNow.
...
⭐ Currently building AI systems that power the next generation of enterprise automation.
